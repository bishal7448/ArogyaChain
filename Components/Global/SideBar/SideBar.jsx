...
//INTERNAL IMPORTS: Importing necessary icons and components
import {
  CgMenuGridR,
  CgMenuHotdog,
  FaUsers,
      ...
      <div className="deznav-scroll">
        ...
        <div className="copyright">
          <p className="fs-14 font-w200">
            <strong className="font-w600">ArogyaChain© </strong>Dashboard
            <br />
            2025 All Rights Reserved
          </p>
          <p className="fs-12">
            Made by <strong className="font-w600">@bishal7448 </strong>
          </p>
        </div>
      </div>
    </div>
